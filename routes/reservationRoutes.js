...
reservationRouter.get("/viewall", userAuthentication,adminAuthentication, reservationController.getAllReservations);
...
reservationRouter.delete("/delete", userAuthentication, reservationController.deleteReservation);
